          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="self-center lg:pr-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 border-2 border-blue-900 text-blue-900 bg-transparent hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold transition-colors"
                >
